...
## 17. Follow-Up Interview Talking Points

### 1. Why Graph Database?

Relationship traversal is the core product behavior.

The application needs to discover people through shared skills and projects, which is naturally represented as graph traversal.

### 2. Why Razor Pages?

The assignment is a relatively small web application.

Razor Pages provides a simple ASP.NET Core application with minimal moving parts while still supporting server-side application logic.

### 3. Why the Official Neo4j Driver?

CognoDB provides Bolt connectivity and supports the official Neo4j driver approach.

Using the official driver also provides parameterised query execution.

### 4. How Are Secrets Protected?

Credentials are supplied through environment variables or configuration and are not hard-coded in source code.

### 5. How Is the Query Safe?

User input is passed as Cypher parameters.

The application does not construct Cypher queries by concatenating user input.

### 6. What Is the Multi-Hop Query?

The main relationship traversal is:
...
This allows the application to find people connected through common skills and project experience.
...
- Relationship-strength explanations
- Interactive graph visualization
- Authentication and authorization
- More advanced skill/project filters
- Query performance telemetry
- Richer recommendation explanations

---

## 18. Assignment Alignment

The Wexa AI assignment requires:

- A thoughtful graph model
- Realistic seed data
- Multi-hop graph queries
- Relationally awkward relationship exploration
- A usable web UI
- Parameterised driver queries
...
GraphLens provides the application, database seed project, graph model, Cypher queries and documentation required for the solution.

The hosted URL, screenshots and screen recording should be added before final submission.

---

## 19. Normal Development Workflow
...
2. Run Seed.csproj
        ↓
3. Demo graph data is created
        ↓
4. Run GraphExplorer.csproj
        ↓
5. Open GraphLens in browser
        ↓
6. Search for people / skills / companies
        ↓
...
- [ ] CognoDB contains demo data
- [ ] GraphLens starts successfully
- [ ] Search functionality verified
- [ ] Explore Connections verified
- [ ] Shared skills verified
- [ ] Shared projects verified
- [ ] `/health` verified
...
- [ ] Screenshots added
- [ ] GitHub repository pushed
- [ ] Hosted demo configured
- [ ] Screen recording prepared

---

**GraphLens — Relationship exploration powered by CognoDB and ASP.NET Core.**